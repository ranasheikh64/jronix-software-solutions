      ...
      <div className="max-w-7xl mx-auto px-6">
        ...
        >
          ...
          <h2 style={{ fontFamily: "Rajdhani, sans-serif", fontWeight: 700, fontSize: "clamp(2rem, 4vw, 3rem)", color: "#e8f4ff" }}>
            Let's Build <span style={{ background: "linear-gradient(90deg, #00aaff, #00d4ff)", WebkitBackgroundClip: "text", WebkitTextFillColor: "transparent" }}>Together</span>
          </h2>
        ...
        <div className="grid lg:grid-cols-5 gap-10">
          ...
          <div className="lg:col-span-3">
            <div className="rounded-2xl p-7" style={{ background: "rgba(13,31,60,0.6)", border: "1px solid rgba(0,170,255,0.12)" }}>
              {submitted ? (
                <motion.div
